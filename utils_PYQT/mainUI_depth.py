...
class Bucket_Window(QWidget, Ui_BucketTime):
    ...
    def show_viedo(self):
        if share_data:
            try:
                Best_action, Better_action, depth = None, None, None
                im0 = share_data['im0']
                ...
                try:
                    ...
                    depth = round(share_data['depth'], 2)
                except Exception:
                    pass
                self.show_cv_img(im0, img_reflect, Best_action, Better_action, depth)
            except Exception:
                pass

    def show_cv_img(self, im0, img_reflect, reflect_best, reflect_better, reflect_depth):
        ...
        self.label_5.setText(_translate("BucketTime", f"Depth-detect:({reflect_depth})"))
